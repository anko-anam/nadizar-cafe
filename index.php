                    ...
                    <div class="left-content">
                        <div class="inner-content">
                            ...
                            <div class="main-white-button scroll-to-section">
                                <a href="#reservation">Pilih Menu</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        <form id="contact" action="chekout.php" method="post">
                          <div class="row">
                            <div class="col-lg-12">
                                <h4>Chekout</h4>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="number-guests" name="number-guests" id="number-guests">
                                    ...
                                    <option name="1" id="1">Nadizar Seblak Mini</option>
                                    <option name="2" id="2">Nadizar Seblak Telor</option>
                                    <option name="3" id="3">Nadizar Seblak Sosis + Mie + Telor</option>
                                    <option name="4" id="4">Nadizar Seblak Full Isi</option>
                                    <option name="5" id="5">Nadizar Seblak Paket Komplit</option>
                                    <option name="6" id="6">Nadizar Es Teh</option>
                                    <option name="7" id="7">Nadizar Pempek Mini</option>
                                    <option name="8" id="8">Nadizar Pempek Kapal Selam</option>
                                    <option name="9" id="9">Nadizar Pempek Paket Komplit</option>
                                </select>
                              </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12">
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="time" name="time" id="time">
                                    ...
                                    <option name="Breakfast" id="Breakfast">BNL</option>
                                    <option name="Lunch" id="Lunch">Metropolis</option>
                                    <option name="Dinner" id="Dinner">Cijeruk</option>
                                </select>
                              </fieldset>
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                              <fieldset>
                                <button type="submit" id="form-submit" class="main-button-icon">Pesan Sekarang</button>
                              </fieldset>
                            </div>
                          </div>
                        </form>
